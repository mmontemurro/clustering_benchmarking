...
# [GCC 7.3.0]
# Embedded file name: /home/marilisa/phylics_sim/cnsc_simulator/Gen_Ref_Fa.py
# Compiled at: 2020-12-03 15:46:19
...
def init_ref_from_npy(prefix):
    len_chr = np.load((prefix + '.leaf_chrlen.npy'), allow_pickle=True)
    leaf_index = np.load((prefix + '.leaf_index.npy'), allow_pickle=True)
    ...
    return (
     list(ref), list(chr_name), list(len_chr), list(corres))
...
# okay decompiling __pycache__/Gen_Ref_Fa.cpython-37.pyc
