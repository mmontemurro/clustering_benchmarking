...
if __name__ == "__main__":
    ...
    parser.add_argument('-st', '--stats', required='True', type=str, help="Stats file.")
    ...
    for t,tree in enumerate(trees):
        ...
        if args.threshold_free is None:
            ...
            clusters = THRESHOLDFREE[args.threshold_free](METHODS[args.method.lower()],tree,threshold,args.support)
